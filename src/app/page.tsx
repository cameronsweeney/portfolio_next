        ...
        <div className={styles.content}>
          ...
          <div className={styles.main_text}>
            <div>
              ...
              <p>I teach math (prealgebra through calculus), language (English, German, and French), test prep (SAT, ACT, SHSAT, IB, and AP), and science (physics and chemistry), and I build websites and programs with <strong>Python</strong>, <strong>JavaScript/Typescript</strong>, and more. This website is built with <strong>HTML</strong>, <strong>CSS/Tailwind</strong>, <strong>JavaScript/Typescript</strong>, <strong>React</strong>, and <strong>Next.js</strong>.</p>
