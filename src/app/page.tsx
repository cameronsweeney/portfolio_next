        ...
        <div className={styles.content}>
          ...
          <div className={styles.main_text}>
            <div>
              ...
              <p>My project experience includes building RESTful APIs with <strong>Python</strong> and <strong>FastAPI</strong>, <strong>Django-REST-Framework</strong>, and <strong>Ruby on Rails</strong>, as well as <strong>PostgreSQL</strong>, <strong>SQLite</strong>, and <strong>MongoDB</strong> databases. I also have experience building front-ends with <strong>JavaScript/Typescript</strong>, <strong>React</strong>, <strong>Redux</strong>, and <strong>Next.js</strong>. Check out some of my recent work on my <Link href="https://github.com/cameronsweeney/">Github</Link>!</p>
            </div>
          </div>
        </div>
      </div>
